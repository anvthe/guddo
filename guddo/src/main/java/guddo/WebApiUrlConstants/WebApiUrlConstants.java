package guddo.WebApiUrlConstants;

public class WebApiUrlConstants {


    public final static String USER_REGISTER_API = "/register";
    public final static String USER_VERIFY_EMAIL_API = "/verify";
    ...
    public final static String USER_FORGOT_PASSWORD_API = "/forgot-password";
    public final static String USER_RESET_PASSWORD_API = "/reset-password";
